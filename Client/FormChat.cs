    ...
    public partial class FormChat : Form
    {
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            if (txtChatInput.Text != null && txtChatInput.Text.Length > 0)
            {
                ...
                if (txtChatWith.Text.Equals("_SERVER", StringComparison.CurrentCultureIgnoreCase))// String: hàm so sánh (xét xem tên có hiển thị vs mọi người) vs current : hiển thị cho mọi người tham gia vào, equals (dùng cho hàm tham chiếu) đồng nghĩa vs ==
                {
        ...
        private void txtChatWith_TextChanged(object sender, EventArgs e)
        {
